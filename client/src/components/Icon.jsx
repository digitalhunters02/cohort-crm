...
const ICONS = {
  ...
  whatsapp: [
    ['path', 'M12 3a9 9 0 0 0-7.8 13.5L3 21l4.6-1.2A9 9 0 1 0 12 3Z'],
    ['path', 'M8.3 9.3c0 4 3.4 7.4 7.4 7.4.7 0 1.1-.6 1.1-1.2v-.9c0-.3-.2-.5-.5-.6l-1.8-.5c-.3 0-.5 0-.7.3l-.4.6c-1.2-.5-2.2-1.5-2.7-2.7l.6-.4c.2-.2.3-.5.2-.7l-.5-1.8c0-.3-.3-.5-.6-.5h-.9c-.6 0-1.2.4-1.2 1.1Z'],
  ],
  send: [
    ['path', 'M4 12 20.5 4 14 20l-2.5-6.5L4 12Z'],
    ['line', 11.5, 13.5, 20.5, 4],
  ],
};
